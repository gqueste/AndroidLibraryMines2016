 ...
 */
public class BookItemClickListener implements RecyclerView.OnItemTouchListener {
    ...
    public BookItemClickListener(Context context, OnItemClickListener listener) {
